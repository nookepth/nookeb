...
const INTRO_TEXT = `สวัสดีครับพี่ๆ ทุกคน
...
ถ้าวันไหนหนูเผลอทำอะไรผิดพลาดไป อย่าเพิ่งดุหนูน้า หนูสัญญาว่าจะตั้งใจปรับปรุงให้เก่งขึ้นเรื่อยๆ
อยากให้เก็บ อยากให้ค้น หรืออยากรวมรูปเป็น PDF เรียกหนูได้ตลอดเลยนะครับ หนูพร้อมช่วยพี่เสมอ`;
